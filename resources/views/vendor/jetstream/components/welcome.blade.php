...
<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    @php $date = Carbon\Carbon::today()->toDateTimeString(); $event = App\Models\Event::with(['requestEvent' => function($q){ $q->where('status', 1); }])->where('user_id',Auth::id())->whereDate('start',$date)->where('status',1)->get();
    @endphp
            ...
            <div class="table">
                <div class="">
                    ...
                    <table class="table table-hover table-bordered">
                        <tr></tr>
                        <tr>
                            <th colspan="8" style="text-align: center;">Today Events</th>
                        </tr>
                        @if($event->count() >= 1)
